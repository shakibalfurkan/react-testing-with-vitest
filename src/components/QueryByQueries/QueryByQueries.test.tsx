...
import QueryByQueries from "./QueryByQueries";

describe("QueryByQueries methods", () => {
  ...
  it("should query by text", () => {
    ...
    const paragraph = screen.queryByText("This is paragraph text.");
  ...
  it("should query by display value", () => {
    ...
    const input = screen.queryByDisplayValue("Pre-field value");
